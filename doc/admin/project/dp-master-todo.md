...
## annotation service
* add handling for queryDataSets() RPC 
  * what indexes are needed on datasets mongo collection?
* add handling for description field of dataset
* rename class DocumentDataBlock to DataBlockDocument?
